...
import com.meteor.chat.api.msg.dto.UserApplyMsgDTO;
...
public class UserFriendServiceImpl implements UserFriendService {
    ...
    public void deleteFriend(FriendDeleteReq req, Long uid) {
        ...
        // 禁用单聊聊天室
        roomCommonApi.disableSingleRoom(SingleRoomDTO.builder().uid1(req.getFriendId()).uid2(uid).build());
    }
